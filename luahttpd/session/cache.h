...
private:
	google::dense_hash_map<unsigned int, unsigned int> m_mapnn;
	google::dense_hash_map<unsigned int, string> m_mapns;
	google::dense_hash_map<string, unsigned int> m_mapsn;
	google::dense_hash_map<string, string> m_mapss;
};
